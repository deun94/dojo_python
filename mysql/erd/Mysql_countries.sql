...
SELECT countries.name AS country_name, cities.name AS city_name, cities.district AS city_district, cities.population FROM countries
...
SELECT countries.region, COUNT(countries.name) as num_countries FROM countries
